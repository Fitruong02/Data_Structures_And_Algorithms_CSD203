...
Assume that we want to build an application that manages a list of birds. Each bird has nickname (string), age (integer), and weight (float).
Students are required to build the application supporting functions below:
